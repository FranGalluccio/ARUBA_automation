...
def test_evento_con_promemoria(page):
    ...
    try:
        ...
        page.screenshot(path=os.path.join(REPORT_FOLDER, f"test_calendario_06_promemoria_{datetime.now():%H-%M-%S}.png"))
        ...
        print(f"test_calendario_06 PASSED — evento: {titolo}")
