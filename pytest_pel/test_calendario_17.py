...
def test_pianificazione_invitato_occupato(page):
    ...
    try:
        ...
        page.screenshot(path=os.path.join(REPORT_FOLDER, f"test_calendario_17_evento_a_{datetime.now():%H-%M-%S}.png"))
        ...
        page.screenshot(path=os.path.join(REPORT_FOLDER, f"test_calendario_17_evento_b_{datetime.now():%H-%M-%S}.png"))
        ...
        page.screenshot(path=os.path.join(REPORT_FOLDER, f"test_calendario_17_expanded_{datetime.now():%H-%M-%S}.png"))
        ...
        page.screenshot(path=os.path.join(REPORT_FOLDER, f"test_calendario_17_planning_{datetime.now():%H-%M-%S}.png"))
        ...
        page.screenshot(path=os.path.join(REPORT_FOLDER, f"test_calendario_17___{datetime.now():%Y-%m-%d_%H-%M-%S}.png"), full_page=True)
        ...
        print("test_calendario_17 PASSED — slot occupato verificato in vista pianificazione")
