...
def test_form_multiutente_pec(page):
    ...
    if multiutente_nav.is_visible():
        ...
        try:
            gestisci_btn.wait_for(state="visible", timeout=5000)
        except Exception:
    ...
    aggiungi_selectors = [
        ...
        'button:has-text("Aggiungi"), button:has-text("Ajouter")',
        'aru-button:has-text("Aggiungi"), button:has-text("Ajouter")',
    ...
    close_selectors = [
        'button[aria-label="Chiudi"], [aria-label="Fermer"]',
        'button:has-text("Annulla"), button:has-text("Annuler")',
        'button:has-text("Cancel")',
        'aru-button:has-text("Annulla"), button:has-text("Annuler")',
        '[title="Chiudi"], [title="Fermer"]',
    ]
