...
def test_modifica_contatto(page):
    ...
    try:
        ...
        page.locator('input[placeholder*="cognome"], input[placeholder*="un nom"]').first.fill("DaModificare", force=True)
        ...
        cognome_input = page.locator('input[placeholder*="cognome"], input[placeholder*="un nom"]').first
