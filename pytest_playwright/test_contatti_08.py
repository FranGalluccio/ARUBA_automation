...
def test_contatto_preferito(page):
    ...
    # Tenta di cliccare il pulsante stella/preferiti nella riga
    # Prova prima con la stella nella colonna star del record
    ...
    if not favorite_added:
        # Tenta con aru-button nella action area (primo bottone = preferiti)
    ...
    try:
        ...
        pref_row.hover()
        time.sleep(0.5)
        # Ri-clicca la stella per rimuovere dai preferiti
