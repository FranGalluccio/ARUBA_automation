...
def test_scrivi_email_da_contatto(page):
    ...
    try:
        ...
        page.locator('input[placeholder*="cognome"], input[placeholder*="un nom"]').first.fill("Contact", force=True)
        page.locator('input[placeholder*="email"], input[placeholder*="courriel"]').first.fill(email_contatto, force=True)
