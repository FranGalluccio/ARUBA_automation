...
def test_impostazioni_cestino(page):
    ...
    if not page.locator('button[title="Cestino"], button[title="Corbeille"], [title="Cestino"], [title="Corbeille"]').first.is_visible():
    ...
    page.locator('button[title="Cestino"], button[title="Corbeille"], [title="Cestino"], [title="Corbeille"]').first.click(force=True)
